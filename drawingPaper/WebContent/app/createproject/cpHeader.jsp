...
<body>
   <div class="create-project__header">
      <div class="outer_frm">
         ...
         <div class="top">
            <div class="top--inner">
               ...
               <div class="top_buttons flex">
                  ...
                  <button class="my_button btn_font_color-red">
                     <span>저장하기</span>
                     <!-- 이부분 어떻게 살릴지 고민해야함 -->
                  </button>
               </div>
         ...
         <!-- 2 -->
         <div class="create_project-title">프로젝트 기획</div>
         ...
         <div>
            <div class="tab_menu">
               <ul>
                  <!-- 현재 페이지 cur_page로 변경 -->
                  <li class="default-info"><a
                     href="defaultInfo.jsp">기본정보</a></li>
                  <li class="funding-plan"><a
                     href="fundingPlan.jsp">펀딩 계획</a></li>
                  <li class="project-plan"><a
                     href="projectPlan.jsp">프로젝트 계획</a></li>
                  <li class="creater-info"><a
                     href="createrInfo.jsp">창작자 정보</a></li>
               </ul>
            </div>
         </div>
      </div>
