...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/login/kakaoLogin.css">
</head>
<body>
<div class="cover">
  <div class="left">
    <div class="contents">
      ...
      <div class="loginArea">
        <div class="top">
          <p class="title1">간편하게 로그인하고</p>
          <p class="title2">세상에 하나뿐인<br />특별한 프로젝트를 발견해보세요</p>
          <a href="#">
            카카오로 로그인
          </a>
        </div>
        <div class="bottom">
          ...
          <p class="join">아직 텀블벅 계정이 없으신가요? <a href="">회원가입</a></p>
        </div>
      </div>
    </div>
  </div>
